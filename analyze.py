...
df_enriched = pd.read_csv('/Users/shenghuali/reddog-scraper/nba_enriched_data.csv')
print(f"Loaded {len(df_enriched)} records.")

print("2. Loading Advanced Stats (Current Strength)")
df_stats = pd.read_csv('/Users/shenghuali/reddog-scraper/nba-advanced-stats.csv')
print(f"Loaded {len(df_stats)} team stats.")
print(df_stats.head(10))

print("3. Loading Injury Data (Game Day Variables)")
injury_files = glob.glob('/Users/shenghuali/reddog-scraper/nba-injury-latest.csv')
if injury_files:
